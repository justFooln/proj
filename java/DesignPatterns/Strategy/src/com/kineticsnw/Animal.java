...
// This is the base class for all animals. It demonstrates strategy - using composition
// to handle specialized behavior needed in the subclasses
public class Animal {
