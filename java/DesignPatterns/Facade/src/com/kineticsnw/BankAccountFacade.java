...
public class BankAccountFacade {
  ...
  public BankAccountFacade(int newAcctNum, int newSecCode, double initBalance){
    ...
    acctChecker = new AccountNumberCheck(newAcctNum);
    codeChecker = new SecurityCodeCheck(newSecCode);
    fundChecker = new FundsCheck(initBalance);
